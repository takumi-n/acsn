 ...
 */
module.exports = function webhookHandler(opts) {
  ...
  app.use(webhookHandshake(opts.storeSecret));
  app.use(refetchSecret(asanaClient, opts.getSecret));
  app.use(verifySignature(opts.getSecret));
